...
public class ConfirmarPagoTest extends BaseTest {
	...
	public void loginAndGoToNuevoPagoPage() {
		...
		codigoPago = super.getTestDataProperties().getProperty("codigoPago");
		...
		firstPaymentPage2 = firstPaymentPage1.getFirstPaymentPage2(rubro, ente, codigoPago);
	...
	public void verifyData() {
		Assert.assertTrue(firstPaymentPage2.validarDatos(rubro, ente, codigoPago));
